...
|---|------|----------------------------------------|--------|
| 1 | Walking skeleton — Vite + React + TS + PWA shell, lint/test/build wired, empty "Today" screen | Start the app locally on phone or computer and see it load | pending |
