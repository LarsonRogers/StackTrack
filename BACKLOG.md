...
| 13 | E2E-encrypted sync backend — 13a server (done 2026-06-12, live + verified); 13b client crypto; 13c tombstones; 13d sync engine + settings UI; 13e live demo. REQUIRED before shipping to other users | Automatic cross-device sync where the server can never read the data | 13a done |
