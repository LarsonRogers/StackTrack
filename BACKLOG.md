...
| 16 | Today-card polish + optional dose unit + persistent per-item note (waves 1–2) | Cleaner Today cards (badge + groups); enter a unit (shown "500 mg"); pin a note shown on Today | W1+W2 done (2026-06-16); Today-card layout cleanup pending (W3-A) |
| 17 | Composite measurements + boolean kind + rename Metrics→"Tracking" (wave 3) | Track blood pressure (120/80) and other multi-number measurements, plus yes/no things; one "Tracking" page | planned — see HANDOFF Wave 3 |
