...
| 17 | Composite measurements + boolean kind + rename Metrics→"Tracking" (wave 3, parts B–D) | Track blood pressure (120/80) and other multi-number measurements, plus yes/no things; one "Tracking" page | planned — see HANDOFF Wave 3 |
