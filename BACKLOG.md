...
| 18 | Health events — log discrete dated events (symptom/appointment/procedure/other), many per day, on the Today screen; shown as color-coded markers on the metric graphs (schema v9, new healthEvents table) | Record "Fever", "GI Doc Appointment", "Appendectomy" and see them lined up against metric trends | done (2026-06-16) — committed local-only, awaiting push |
| 19 | Collapsible Today sections — Events, Journal, Daily metrics, and "Also recorded" collapse with state remembered (localStorage) | Tidy the Today screen by hiding sections you're not using | done (2026-06-16) — committed local-only, awaiting push |
